...
## To programatically drop a table instead of disconnecting and reconnecting to clear temporary tables
...
SET avg_salary = 63805.4; -- 63811 on ryan's

#SET avg_salary = (select avg(salary) from employees.salaries);

UPDATE department_avg_pay
SET std_salary = 16900.85; -- 16905 on ryan's
# set std_salary = (select stddev(salary) from employees.salaries);
